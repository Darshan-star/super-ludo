...
<div class="control3"> 
<div class="lb"><button id="move-blue1" class="player playersel1 bg-red"></button>&nbsp;&nbsp;<span id="red_player_name" class="f"><input type="text" class="cun"><button class="bot botoff"></button></span></div>
<div class="lb"><button id="move-blue2" class="player playersel2 bg-green"></button>&nbsp;&nbsp;<span id="green_player_name" class="f"><input type="text" class="cun"><button class="bot botoff"></button></span> </div>
<div class="lb"><button id="move-blue3" class="player playersel3 bg-yellow"></button>&nbsp;&nbsp;<span id="yellow_player_name" class="f"><input type="text" class="cun"><button class="bot botoff"></button></span> </div>
<div class="lb"><button id="move-blue4" class="player playersel4 bg-blue"></button>&nbsp;&nbsp;<span id="blue_player_name" class="f"><input type="text" class="cun"><button class="bot botoff"></button></span> </div>
</div>
...
<span class="visually-hidden">Loading...</span>
       ...
       <hr>
<div class="super-center">Developed By Darshan Yadav /&nbsp;<a href="https://darshan-star.github.io/portfolio/" class="text-decoration-none" target="_blank">Follow</a></div> 
